...
SELECT * FROM 'https://data.source.coop/tge-labs/st-louis-open-data-mirror/property-taxes/property-taxes.parquet' LIMIT 5;
```
...
COPY (
  ...
  FROM 'https://data.source.coop/tge-labs/st-louis-open-data-mirror/property-taxes/property-taxes.parquet' t
...
Mirror of [Property Taxes](https://www.stlouis-mo.gov/data/datasets/dataset.cfm?id=3) from the City of St. Louis open data portal; source: https://www.stlouis-mo.gov/data/upload/data-files/prcl.zip. No explicit license is published — see the portal page. Synced 2026-08-05T17:48:01+00:00.
