...
- [View on the data browser](https://cholmes.github.io/stlouis-data-browser/#/building/mechanical-permits/collection.json) — map, styles, legends, downloads
- [Browse on Source Cooperative](https://source.coop/tge-labs/st-louis-open-data-mirror/building/mechanical-permits/) — rendered README and file listing
