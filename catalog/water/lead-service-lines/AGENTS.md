...
PMTiles for maps: `https://data.source.coop/tge-labs/st-louis-open-data-mirror/water/lead-service-lines/lead-service-lines.pmtiles` (layer `lead-service-lines`), styled by `styles/*.json` — `styles/default.json` is the default.
