...
PMTiles for maps: `https://data.source.coop/tge-labs/st-louis-open-data-mirror/forestry/city-trees/city-trees.pmtiles` (layer `city-trees`), styled by `styles/*.json` — `styles/default.json` is the default.
