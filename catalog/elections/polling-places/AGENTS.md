...
PMTiles for maps: `https://data.source.coop/tge-labs/st-louis-open-data-mirror/elections/polling-places/polling-places.pmtiles` (layer `polling-places`), styled by `styles/*.json` — `styles/default.json` is the default.

Full schema: `table:columns` in collection.json.

## Links

- [View on the data browser](https://cholmes.github.io/stlouis-data-browser/#/elections/polling-places/collection.json) — map, styles, legends, downloads
- [Browse on Source Cooperative](https://source.coop/tge-labs/st-louis-open-data-mirror/elections/polling-places/) — rendered README and file listing
