...
SELECT * FROM 'https://data.source.coop/tge-labs/st-louis-open-data-mirror/tornado-damage-2025/tornado-damage-2025.parquet' LIMIT 5;
```

PMTiles for maps: `https://data.source.coop/tge-labs/st-louis-open-data-mirror/tornado-damage-2025/tornado-damage-2025.pmtiles` (layer `tornado-damage-2025`), styled by `styles/*.json` — `styles/default.json` is the default.
