...
COPY (
  ...
  FROM 'https://data.source.coop/tge-labs/st-louis-open-data-mirror/housing/occupancy-permits/occupancy-permits.parquet' t
...
- [View on the data browser](https://cholmes.github.io/stlouis-data-browser/#/housing/occupancy-permits/collection.json) — map, styles, legends, downloads
- [Browse on Source Cooperative](https://source.coop/tge-labs/st-louis-open-data-mirror/housing/occupancy-permits/) — rendered README and file listing
