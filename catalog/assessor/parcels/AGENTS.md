...
PMTiles for maps: `https://data.source.coop/tge-labs/st-louis-open-data-mirror/assessor/parcels/parcels.pmtiles` (layer `parcels`), styled by `styles/*.json` — `styles/default.json` is the default.
