...
SELECT * FROM 'https://data.source.coop/tge-labs/st-louis-open-data-mirror/vacancy-composite/vacancy-composite.parquet' LIMIT 5;
```

PMTiles for maps: `https://data.source.coop/tge-labs/st-louis-open-data-mirror/vacancy-composite/vacancy-composite.pmtiles` (layer `vacancy-composite`), styled by `styles/*.json` — `styles/default.json` is the default.
