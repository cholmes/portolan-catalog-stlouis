...
### [City Boundary](catalog/city-boundary/)

St. Louis City limits

### [City Trees (Planting Sites)](catalog/city-trees/)

All mapped planting sites within the city for tree plantings managed by the Forestry Division. Street tree planting sites are re-used, while park tree sites tend not to be. This data contains vacan...

### [Community Improvement Districts (CIDs)](catalog/community-improvement-districts/)

Community improvement districts (CIDs) within the City of Saint Louis. CIDs are established by the section of Missouri statute known as the "Community Improvement District Act". More info: http://r...

### [CSB Service Requests (311)](catalog/csb-311-requests/)

The Citizens' Service Bureau (CSB) is the customer service department for the City of St. Louis. This dataset provides access to some of the data collected when services are requested. The X/Y coor...

### [Election Wards & Precincts](catalog/election-precincts/)
...
Qualified Opportunity Zones (QOZs) within the City of Saint Louis. Qualified Opportunity Zones are nominated for that designation by the state and that nomination has been certified by the Secretar...

### [Parcels](catalog/parcels/)
